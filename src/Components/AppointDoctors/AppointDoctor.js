...
const AppointDoctor = () => {
    ...
    const [appointDoctor, setAppointDocotr] = useState({})
    const url = `https://my-json-server.typicode.com/nazim725/Doctors/posts/${doctorId}`
    useEffect(() => {
        fetch(url)
            .then(res => res.json())
            .then(data => setAppointDocotr(data))
    }, [doctorId])
    return (
        ...
        <Form className='booking-form'>
            <Row className="mb-3">
                <Form.Group as={Col} controlId="formGridEmail">
                    ...
                    <Form.Control value={appointDoctor.name} />
                </Form.Group>
            </Row>
            <Row>
                ...
                <Form.Group as={Col} controlId="formGridPassword">
                    ...
                    <Form.Control value={appointDoctor.Designation} />
                </Form.Group>
            </Row>
            <Row>
                <Form.Group className="mb-3" controlId="formGridAddress1">
                    <Form.Label>Doctor's Email</Form.Label>
                    <Form.Control value={appointDoctor.email} />
                </Form.Group>
            </Row>
            ...
            <Row>
                <Form.Group className="mb-3" controlId="formGridAddress1">
                    ...
                    <Form.Control value={appointDoctor.address} />
                </Form.Group>
            </Row>
            <Row>
                <Form.Group className="mb-3" controlId="formGridAddress1">
                    <Form.Label>Doctor's Phone</Form.Label>
                    <Form.Control value={appointDoctor.phone} />
                </Form.Group>
            </Row>
            <Row>
                <Form.Group className="mb-3" controlId="formGridAddress1">
                    <Form.Label>Doctor's Consultation Fee</Form.Label>
                    <Form.Control value={appointDoctor.fee} />
                </Form.Group>
            </Row>
            <Row>
                <Form.Group className="mb-3" controlId="formGridAddress1">
